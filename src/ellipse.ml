...
let make_bifocal p1 p2 radius =
  ...
  { f1 = p1; f2 = p2; radius; big_axis; small_axis = b *. 2. }
...
let rotate e c f =
  { e with f1 = Point.rotate e.f1 c f; f2 = Point.rotate e.f2 c f }

let rotate_angle e c f =
  { e with f1 = Point.rotate_angle e.f1 c f; f2 = Point.rotate_angle e.f2 c f }
